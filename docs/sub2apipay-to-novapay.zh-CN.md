[English](./sub2apipay-to-novapay.md)

# Sub2ApiPay 到 NovaPay 的结构演进（历史记录）

> 这是一份历史文档。NovaPay 早期从一个名为 `sub2apipay` 的项目（一个面向「Sub2API」内部用户充值/订阅的支付脚本）中提炼支付网关骨架而来。本文记录了当时的取舍和迁移决策；如果你只关心当前架构，参考 [README.zh-CN.md](../README.zh-CN.md) 和 [production-runbook.zh-CN.md](./production-runbook.zh-CN.md) 即可。
...
- [production-runbook.zh-CN.md](./production-runbook.zh-CN.md) —— 生产部署
- [merchant-integration-examples.zh-CN.md](./merchant-integration-examples.zh-CN.md) —— 商户接入示例
- [`apps/registry/README.zh-CN.md`](../apps/registry/README.zh-CN.md) —— 插件市场详细说明
