...
interface CreateRefundForOrderRequestBody {
...
function parseBody(body: CreateRefundForOrderRequestBody) {
...
export async function POST(
  ...
  try {
    ...
    parsedBody = parseBody(JSON.parse(rawBody) as CreateRefundForOrderRequestBody);
  } catch (error) {
